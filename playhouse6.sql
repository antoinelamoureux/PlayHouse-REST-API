...
--
-- Host: localhost:8889
-- Generation Time: Mar 02, 2021 at 10:08 PM
...
INSERT INTO `games` (`id_game`, `add_date`, `cover`, `description`, `price`, `release_date`, `title`, `id_category`, `id_classification`, `id_developper`, `id_editor`, `id_note`, `id_state`, `category_id_category`, `id`) VALUES
(1, '2021-02-28 22:33:01', NULL, 'Metal Slug est un jeu vidéo d\'arcade, de type shoot \'em up ou qui peut également être désigné par run and gun, paru à l\'origine sur Neo-Geo MVS. Le jeu est similaire dans son principe à Contra et mêle humour décalé et action.', NULL, '1996-04-19 00:00:00', 'Metal Slug', 1, 4, 1, 1, 4, 2, 0, 0),
(2, '2021-02-28 22:33:02', NULL, 'Gran Turismo est une série de jeux vidéo de course automobile conçue par le studio japonais Polyphony Digital, dirigée par Kazunori Yamauchi et produite par Sony Computer Entertainment sur les consoles de la gamme PlayStation. Débutée en 1997, la série comprend sept épisodes principaux et cinq déclinaisons. Réputée pour le réalisme visuel et la profondeur des sensations de pilotage, c\'est l\'une des séries de jeux vidéo plus populaires du genre avec plus de 80 millions d\'exemplaires vendus (en mai 2018).', NULL, '1997-01-01 00:00:00', 'Gran Turismo', 2, 3, 2, 2, 2, 5, 0, 0),
(4, '2015-06-23 02:00:00', 'batman-arkham-knight-edition-jeu-de-l-annee-ps4-595aa7d6c2ef1.jpg', 'Rocksteady Studios is a multi-award winning video-game developer based in London, England. \nLocated in a spacious, purpose built converted factory, with full motion capture and audio studio \ncapabilities, consisting of an energetic company formed by a core team \nof senior industry professionals.', '999.00', '2015-06-23 02:00:00', 'Batman: Arkham Knight', 2, 4, 2, 2, 2, 2, 0, 0),
(6, '2019-04-23 02:00:00', '3E2C8313-78BC-41BA-A872-53FFA3E56FC3.jpeg', 'Mortal Kombat is back and better than ever in the next evolution of the iconic franchise.\nThe all new Custom Character Variations give you unprecedented control of your fighters to make them\n your own. The new graphics engine showcases every skull-shattering, eye-popping moment, \n bringing you so close to the fight you can feel it. Featuring a roster of new and \n returning Klassic Fighters, Mortal Kombat\'s best-in-class cinematic story mode continues \n the epic saga over 25 years in the making.', '69.00', '2019-04-23 02:00:00', 'Mortal Kombat 11', 1, 5, 5, 4, 3, 2, 0, 0),
(14, '2003-11-07 01:00:00', '51itRIeUl0L._AC_SY445_.jpg', 'The Mushroom Kingdom just got a whole lot more hectic as Mario and friends double up for furious kart racing. \nThis time around, each kart holds two racers that can switch places at any time, so choose from a huge cast \nof favorites and pair them up any way you see fit. The character in front handles the driving duties, \n the character in the rear doles out damage with six normal items and eight special items that only \n specific characters can use. Get ready for some intense multiplayer mayhem with your favorite \n characters, including Mario, Luigi, Donkey Kong, Peach, Bowser, and Koopa.\n', '99.00', '2003-11-07 01:00:00', 'Mario Kart: Double Dash!!', 2, 1, 3, 3, 3, 2, 0, 0),
(16, '2019-03-15 01:00:00', '71qgd3r2aFL.jpg', 'The Division 2 is an action-shooter RPG set in an open-world. Play in co-op and PvP modes that offer \nmore variety in missions and challenges, new progression systems with unique twists and surprises, \nand fresh gaming innovations to engage players for years to come.', '79.00', '2019-03-15 01:00:00', 'Tom Clancy\'s The Division 2', 15, 3, 6, 5, 2, 3, 0, 0),
(18, '2015-01-31 01:00:00', '71xg7Z0-yRL._AC_SX466_.jpg', 'Minecraft is a sandbox building video game which allows players to build constructions out of textured\n cubes in a 3D world. The gameplay is inspired by Dwarf Fortress, Roller Coaster Tycoon, \n Dungeon Keeper, and Infiniminer.', '59.00', '2015-01-31 01:00:00', 'Minecraft: Playstation Vita Edition', 7, 1, 10, 8, 2, 5, 0, 0),
(20, '2019-11-08 01:00:00', 'need-for-speed-heat-ps4-e165760.jpg', 'Hustle by day and risk it all at night in Need for Speed Heat, a white-knuckle street racer, where the \nlines of the law fade as the sun starts to set. By day, Palm City hosts the Speedhunter Showdown, \na sanctioned competition where you earn Bank to customize and upgrade your high-performance cars. \nAt night, ramp up the intensity in illicit street races that build your reputation, getting you access \nto bigger races and better parts. But stay ready – cops are waiting and not all of them play fair\n', '69.00', '2019-11-08 01:00:00', 'Need for Speed: Heat', 12, 2, 7, 8, 3, 1, 0, 0),
(22, '2013-09-17 02:00:00', '1581607644-61s8HfeFoL.jpg', 'The biggest, most dynamic and most diverse open world ever created, Grand Theft Auto V blends \nstorytelling and gameplay in new ways as players repeatedly jump in and out of the lives of the game’s\n three lead characters, playing all sides of the game’s interwoven story.', '79.00', '2013-09-17 02:00:00', 'Grand Theft Auto V', 1, 4, 11, 9, 4, 2, 0, 0);
...
(1, 'testuser@gmail.com', '$2a$10$BrYw2.NQjt3YL8bu5o1vYuvzoMthtzjPCnYs1h1GoZiSVY4y4tzBq', 'testuser');
...
--
ALTER TABLE `games`
  MODIFY `id_game` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
