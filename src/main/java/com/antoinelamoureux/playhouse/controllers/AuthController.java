...
import com.antoinelamoureux.playhouse.payload.request.LoginRequest;
import com.antoinelamoureux.playhouse.payload.request.SignupRequest;
import com.antoinelamoureux.playhouse.payload.response.JwtResponse;
import com.antoinelamoureux.playhouse.payload.response.MessageResponse;
import com.antoinelamoureux.playhouse.repository.RoleRepository;
import com.antoinelamoureux.playhouse.repository.UserRepository;
import com.antoinelamoureux.playhouse.security.jwt.JwtUtils;
import com.antoinelamoureux.playhouse.security.services.UserDetailsImpl;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.ROLE_USER)
					.orElseThrow(() -> new RuntimeException("Error: Role is not found (NULL)"));
			roles.add(userRole);
